...
class PositionwiseFeedForward(nn.Module):
    ...
    def forward(self, x):
        ...
        inter = self.dropout_1(self.relu(self.w_1(input)))
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, inputs, mask):
        ...
        #                             mask=mask)
        context = self.self_attn(inputs, input_norm, input_norm,
                                    mask=mask)
        out = self.dropout(context) + input_norm
        return self.layer_norm(self.feed_forward(out))
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, context, embeddings):
        super(TransformerEncoder, self).__init__()

        num_layers = context.opts['self_att_num_layers']
        hidden_size = context.opts['self_att_hid_size']
        dropout = context.opts['self_att_dropout']
    ...
    def forward(self, input, lengths=None, hidden=None):
        ...
        n_batch, s_len, emb_dim = emb.size()
